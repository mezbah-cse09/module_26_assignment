    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    <button type="button" id="delete-modal-close" class="btn btn-success mx-2" data-dismiss="modal">Cancel</button>
...
<script>
     async  function  itemDelete(){
            ...
            showLoader();
            let res=await axios.post("/admin/delete-car",{id:id,file_path:deleteFilePath})
            hideLoader();
            if(res.data===1){
